...
-- User's won't normally be writing this code. Some kind of 2D application editor interface will let users place objects visually and set constructor parameters, but the editior will internally convert it to its corresponding type-script code.
